...
tic
[PID.II.Vis(n), PID.MI_SR.Vis(n), PID.MI_BR.Vis(n), PID.MI_SB.Vis(n), PID.NRSI.Vis(n), PID.ICI.Vis(n), PID.MISB_not_in_R(n).Vis, PID.MISRgB.Vis, PID.MIBRgS.Vis, PID.SI_s_greaterthan_SI_c.Vis] ...
=intersection_information(pv);

[PID.II.Aud(n), PID.MI_SR.Aud(n), PID.MI_BR.Aud(n), PID.MI_SB.Aud(n), PID.NRSI.Aud(n), PID.ICI.Aud(n), PID.MISB_not_in_R(n).Aud, PID.MISRgB.Aud, PID.MIBRgS.Aud, PID.SI_s_greaterthan_SI_c.Aud] ...
