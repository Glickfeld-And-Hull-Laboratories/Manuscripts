function [I_II, S_R_info, C_R_info, S_C_info, non_readout_sensory_info, internal_choice_info, ...
    S_C_info_from_unobserved_R, SI_s, SI_c, SI_s_greaterthan_SI_c]=intersection_information(p_src)
...
% SI_c is shared information, i.e. information about c that could be
% extracted from either S or R
% SI_s is shared information, i.e. information about s that could be
% extracted from either C or R
...
[I_II,loc]=min(SI_c,SI_s);
SI_s_greaterthan_SI_c = loc-1;
