...
savePathName = ['Z:\home\jen\Analysis\HVA recording\Pair Connectivity\',param.rec_date{1}];
...
try
    xlswrite('Z:\home\jen\Notebook files\HVA Recording\HVA_IN_pyr_pair_connectivity.xlsx',{[savePathName,'\',param.rec_date{1},'_pairConnectivity']},u_input,['K' num2str(index+1)]);
catch
