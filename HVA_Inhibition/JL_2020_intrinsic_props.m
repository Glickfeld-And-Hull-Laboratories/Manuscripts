...
% load data
summary_table = readtable('grouped_interneuron_properties_combined.xlsx');
...
save(['Z:\home\jen\Analysis\HVA Recording\Interneuron properties\',param.filename],'spikes','param');

try
    xlswrite('Z:\home\jen\Notebook files\HVA recording\Interneuron_properties_combined.xlsx',...
    {['Z:\home\jen\Analysis\HVA Recording\Interneuron properties\',filename]},1,...
    ['M' num2str(file_idx)]);
catch
